...
const { migrarColumnasFaltantes } = require('./migrate-columns');
...
async function init() {
    ...
    // Por si esta base de datos viene de una version anterior del
    // esquema (ej. se corrio "npm run migrate" manualmente sobre una
    // BD ya existente): agrega columnas nuevas sin tocar los datos.
