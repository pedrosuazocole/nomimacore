...
const hikvisionRouter = require('./routes/hikvision');
...
// Integracion con relojes biometricos Hikvision: publica a proposito
// (el puente local no tiene sesion de usuario), protegida por su propia
// API key dentro del controlador.
